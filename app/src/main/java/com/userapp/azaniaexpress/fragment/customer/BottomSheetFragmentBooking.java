package com.userapp.azaniaexpress.fragment.customer;
...
import com.userapp.azaniaexpress.adapter.CategoryVehicleAdapter;
import com.userapp.azaniaexpress.controller.AppController;
import com.userapp.azaniaexpress.directionhelpers.FetchURL;
import com.userapp.azaniaexpress.model.CategoryVehiclePojo;
import com.userapp.azaniaexpress.model.M;
import com.userapp.azaniaexpress.onclick.ClickListener;
import com.userapp.azaniaexpress.onclick.RecyclerTouchListener;
...
//                if(img_data!=null) {
                ...
                Log.i("iiiiiiiiii","iiiiiii"+img_data);
                    if (!img_data.equals("")) {
...
//            intput_layout_people_number.setError(context.getResources().getString(R.string.enter_a_number_greater_than));
    ...
    private static void getStaticMap(){
        ...
        if(points.size() != 0){
            ...
            final String STATIC_MAP_API_ENDPOINT = "http://maps.googleapis.com/maps/api/staticmap?size=1000x300&markers="+loc1.getLatitude()+","+loc1.getLongitude()+"|"+loc2.getLatitude()+","+loc2.getLongitude()+"&path=color:0x000000|"+path+"&sensor=false&key=AIzaSyCJcz8ajiz0fb1ML-25Ljq9UnibqCqK_ps";
            ...
            Glide.with((Activity) context)
                    ...
                    .into(new SimpleTarget<Bitmap>() {
                        ...
                        public void onResourceReady(@NonNull Bitmap bitmap, @Nullable Transition<? super Bitmap> transition) {
                            ...
                            Log.i("iiiiiiiiii","iiiiii33"+getStringImage(bitmap));
                            // loading model cover using Glide library
